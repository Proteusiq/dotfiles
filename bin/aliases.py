...
def add_aliases(category: str, aliases: list[tuple[str, str, str]]) -> None:
    ...
    table = Table(box=ROUNDED, title=f"[blue bold]{category}[/]", border_style="blue", width=160)
    table.add_column("Alias", style="cyan bold", width=15)
    table.add_column("Command", style="green", width=55)
    table.add_column("Description", width=85)
